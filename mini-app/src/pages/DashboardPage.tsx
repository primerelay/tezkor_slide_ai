...
import { Plus, FileText, Clock, ChevronRight, Wallet, Sparkles, Gift, Brain, BookOpen, PenLine, Layers, GraduationCap, Newspaper, ScrollText, BookMarked, Puzzle } from 'lucide-react';
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <button
              onClick={() => {
                haptic('light');
                navigate('/document/create?type=insho');
              }}
              className="card p-4 text-left active:bg-rose-50 transition-colors"
            >
            ...
            {/* Kurs ishi */}
            <button
              onClick={() => { haptic('light'); navigate('/document/create?type=kurs_ishi'); }}
              className="card p-4 text-left active:bg-indigo-50 transition-colors"
            >
              <div className="w-10 h-10 rounded-xl bg-indigo-100 flex items-center justify-center mb-3">
            ...
            {/* Maqola */}
            <button
              onClick={() => { haptic('light'); navigate('/document/create?type=maqola'); }}
              className="card p-4 text-left active:bg-cyan-50 transition-colors"
            >
            ...
            {/* Tezis */}
            <button
              onClick={() => { haptic('light'); navigate('/document/create?type=tezis'); }}
              className="card p-4 text-left active:bg-violet-50 transition-colors"
            >
            ...
            {/* Glossary */}
            <button
              onClick={() => { haptic('light'); navigate('/study/create?type=glossary'); }}
              className="card p-4 text-left active:bg-emerald-50 transition-colors"
            >
              <div className="w-10 h-10 rounded-xl bg-emerald-100 flex items-center justify-center mb-3">
            ...
            {/* Crossword */}
            <button
              onClick={() => { haptic('light'); navigate('/study/create?type=crossword'); }}
              className="card p-4 text-left active:bg-teal-50 transition-colors"
            >
